...
function Bulk-EdFiOdsApplications {
    ...
    param (
        ...
        # The Admin Api url, Example: https://localhost/AdminApi1x.
        [string]
        $BaseApiUrl,

        # The namespace or namespaces(separated by coma) for the vendor, Example: uri://ed-fi.org/ .
        [string]
        $namespacePrefixes = "uri://ed-fi.org/",
        ...
        # The Secret to authenticate with the API.
        [string]
        $Secret = "",

        # The claim name that will be assigned to the application, Ex: "District Hosted SIS Vendor".
        [string]
        $ClaimsetName = "District Hosted SIS Vendor",


        # The limit the number of resources in each page.
        [int]
        $PageSize = 1000,
...
Function Get-Resource
{
    ...
    $baseApiUrl= $Config.BaseApiUrl
    $uri = "$baseApiUrl" + "$EndPoint" + "?offset=0&limit=$($Config.PageSize)"
    try {
...
<#
.SYNOPSIS
   function that allows us to create payloads for vendors and  applications
#>
